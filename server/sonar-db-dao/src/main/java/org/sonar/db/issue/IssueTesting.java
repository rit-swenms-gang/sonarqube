...
public class IssueTesting {
  ...
  public static IssueDto newIssue(RuleDto rule, ComponentDto branch, ComponentDto file) {
    checkArgument(branch.qualifier().equals(ComponentQualifiers.PROJECT),
        "Second parameter should be a branch that belongs to a project");
  ...
  public static IssueDto newIssue(RuleDto rule, String branchUuid, String projectKey, ComponentDto file) {
    return new IssueDto()
        ...
        .addImpact(new ImpactDto().setSoftwareQuality(SoftwareQuality.MAINTAINABILITY)
