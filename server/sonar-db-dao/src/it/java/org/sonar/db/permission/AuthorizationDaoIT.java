...
class AuthorizationDaoIT {
    ...
    void keepAuthorizedEntityUuids_returns_empty_for_user_if_project_set_is_empty_on__project() {
        assertThat(
                underTest.keepAuthorizedEntityUuids(dbSession, Collections.emptySet(), user.getUuid(),
    ...
    void keepAuthorizedEntityUuids_returns_empty_for_user_for_non_existent_projects() {
        ...
        assertThat(
                underTest.keepAuthorizedEntityUuids(dbSession, randomNonProjectsSet, user.getUuid(),
                        ProjectPermission.USER))
                .isEmpty();
    }
    ...
    void keepAuthorizedEntityUuids_returns_any__project_for_group_AnyOne_without_any_permission_in_DB_and_permission_USER() {
        assertThat(
                underTest.keepAuthorizedEntityUuids(dbSession, randomPublicEntityUuids, null, ProjectPermission.USER))
    ...
    void keepAuthorizedEntityUuids_returns_any__project_for_user_without_any_permission_in_DB_and_permission_USER() {
        assertThat(
                underTest.keepAuthorizedEntityUuids(dbSession, randomPublicEntityUuids, user.getUuid(),
                        ProjectPermission.USER))
                .containsAll(randomPublicEntityUuids);
    }
    ...
    void keepAuthorizedEntityUuids_returns_any__project_for_group_AnyOne_without_any_permission_in_DB_and_permission_CODEVIEWER() {
        assertThat(
                underTest.keepAuthorizedEntityUuids(dbSession, randomPublicEntityUuids, null,
    ...
    void keepAuthorizedEntityUuids_returns_any__project_for_user_without_any_permission_in_DB_and_permission_CODEVIEWER() {
        assertThat(underTest.keepAuthorizedEntityUuids(dbSession, randomPublicEntityUuids, user.getUuid(),
                ProjectPermission.CODEVIEWER))
                .containsAll(randomPublicEntityUuids);
    }
    ...
    void keepAuthorizedEntityUuids_returns__project_if_user_is_granted_project_permission_directly() {
        ...
        assertThat(underTest.keepAuthorizedEntityUuids(dbSession, singleton(project.getUuid()), otherUser.getUuid(),
                randomPermission))
                .isEmpty();
        assertThat(underTest.keepAuthorizedEntityUuids(dbSession, singleton(otherProject.getUuid()), user.getUuid(),
                randomPermission))
                .isEmpty();
        assertThat(
                underTest.keepAuthorizedEntityUuids(dbSession, singleton(project.getUuid()), user.getUuid(),
                        randomPermission))
    ...
    void keepAuthorizedEntityUuids_returns__project_if_user_is_granted_project_permission_by_group() {
        ...
        assertThat(
                underTest.keepAuthorizedEntityUuids(dbSession, singleton(project.getUuid()), user.getUuid(),
                        randomPermission))
                .containsOnly(project.getUuid());
        assertThat(underTest.keepAuthorizedEntityUuids(dbSession, singleton(otherProject.uuid()), user.getUuid(),
                randomPermission))
                .isEmpty();
        assertThat(underTest.keepAuthorizedEntityUuids(dbSession, singleton(project.getUuid()), otherUser.getUuid(),
                randomPermission))
    ...
    void keepAuthorizedEntityUuids_returns__project_if_group_AnyOne_is_granted_project_permission_directly() {
        ...
        assertThat(underTest.keepAuthorizedEntityUuids(dbSession, singleton(project.getUuid()), null, "another perm"))
                .isEmpty();
        assertThat(
                underTest.keepAuthorizedEntityUuids(dbSession, singleton(otherProject.getUuid()), null,
                        randomPermission))
                .isEmpty();
    }
    ...
    void keepAuthorizedEntityUuids_returns_empty_for_user_on_private_project_without_any_permission_in_DB_and_permission_USER() {
        assertThat(underTest.keepAuthorizedEntityUuids(dbSession, randomPrivateEntityUuids, user.getUuid(),
                ProjectPermission.USER))
                .isEmpty();
    }
    ...
    void keepAuthorizedEntityUuids_returns_empty_for_group_AnyOne_on_private_project_without_any_permission_in_DB_and_permission_USER() {
        assertThat(
                underTest.keepAuthorizedEntityUuids(dbSession, randomPrivateEntityUuids, null, ProjectPermission.USER))
                .isEmpty();
    }
    ...
    void keepAuthorizedEntityUuids_returns_empty_for_group_AnyOne_on_private_project_without_any_permission_in_DB_and_permission_CODEVIEWER() {
        assertThat(
                underTest.keepAuthorizedEntityUuids(dbSession, randomPrivateEntityUuids, null,
                        ProjectPermission.CODEVIEWER))
                .isEmpty();
    }
    ...
    void keepAuthorizedEntityUuids_returns_empty_for_user_and_any_permission_on_private_project_without_any_permission_in_DB() {
        ...
        assertThat(
                underTest.keepAuthorizedEntityUuids(dbSession, randomPrivateEntityUuids, user.getUuid(),
                        randomPermission))
                .isEmpty();
    }
    ...
    void keepAuthorizedEntityUuids_returns_private_project_if_user_is_granted_project_permission_by_group() {
        ...
        assertThat(
                underTest.keepAuthorizedEntityUuids(dbSession, singleton(project.uuid()), user.getUuid(),
                        randomPermission))
        ...
        assertThat(underTest.keepAuthorizedEntityUuids(dbSession, singleton(otherProject.uuid()), user.getUuid(),
                randomPermission))
                .isEmpty();
        assertThat(underTest.keepAuthorizedEntityUuids(dbSession, singleton(project.uuid()), otherUser.getUuid(),
                randomPermission))
                .isEmpty();
    }
    ...
    void user_should_be_authorized() {
        ...
        assertThat(underTest.keepAuthorizedEntityUuids(dbSession, newHashSet(project2.getUuid(), project3.getUuid()),
                user.getUuid(),
                ProjectPermission.USER))
                .containsOnly(project2.getUuid(), project3.getUuid());

        // user does not have the role "admin"
        assertThat(underTest.keepAuthorizedEntityUuids(dbSession, newHashSet(project2.getUuid()), user.getUuid(),
    ...
    void anonymous_should_be_authorized() {
        ...
        assertThat(
                underTest.keepAuthorizedEntityUuids(dbSession, newHashSet(project1.getUuid(), project2.getUuid()), null,
                        ProjectPermission.USER))
    ...
    void keepAuthorizedEntityUuids_should_be_able_to_handle_lots_of_projects() {
        List<ProjectDto> projects = IntStream.range(0, 2000)
                .mapToObj(i -> db.components().insertPublicProject().getProjectDto()).toList();
    ...
    void keepAuthorizedUsersForRoleAndEntity_returns_empty_if_user_set_is_empty_on__project() {
        ...
        assertThat(
                underTest.keepAuthorizedUsersForRoleAndEntity(dbSession, Collections.emptySet(), ProjectPermission.USER,
                        project.getUuid()))
                .isEmpty();
    }
    ...
    void keepAuthorizedUsersForRoleAndEntity_returns_empty_for_non_existent_users() {
        ...
        Set<String> randomNonExistingUserUuidsSet = IntStream.range(0, 1 + Math.abs(random.nextInt(5)))
                .mapToObj(i -> Uuids.create())
                .collect(Collectors.toSet());

        assertThat(underTest.keepAuthorizedUsersForRoleAndEntity(dbSession, randomNonExistingUserUuidsSet,
                ProjectPermission.USER, project.getUuid()))
                .isEmpty();
    }
    ...
    void keepAuthorizedUsersForRoleAndEntity_returns_any_users_for__project_without_any_permission_in_DB_and_permission_USER() {
        ...
        assertThat(underTest.keepAuthorizedUsersForRoleAndEntity(dbSession, randomExistingUserUuids,
                ProjectPermission.USER,
                project.getUuid()))
    ...
    void keepAuthorizedUsersForRoleAndEntity_returns_any_users_for__project_without_any_permission_in_DB_and_permission_CODEVIEWER() {
        ...
        assertThat(underTest.keepAuthorizedUsersForRoleAndEntity(dbSession, randomExistingUserUuids,
                ProjectPermission.CODEVIEWER, project.getUuid()))
                .containsAll(randomExistingUserUuids);
    }
    ...
    void keepAuthorizedUsersForRoleAndEntity_returns_empty_for_any_users_on__project_without_any_permission_in_DB() {
        ...
        assertThat(underTest.keepAuthorizedUsersForRoleAndEntity(dbSession, randomExistingUserUuids, randomPermission,
                project.getUuid()))
                .isEmpty();
    }
    ...
    void keepAuthorizedUsersForRoleAndEntity_returns_user_if_granted_project_permission_directly_on__project() {
        ...
        assertThat(underTest.keepAuthorizedUsersForRoleAndEntity(dbSession, singleton(user.getUuid()), "another perm",
                project.getUuid()))
                .isEmpty();
        assertThat(
                underTest.keepAuthorizedUsersForRoleAndEntity(dbSession, singleton(otherUser.getUuid()),
                        randomPermission,
                        project.getUuid()))
                .isEmpty();
        assertThat(underTest.keepAuthorizedUsersForRoleAndEntity(dbSession, singleton(user.getUuid()), randomPermission,
    ...
    void keepAuthorizedUsersForRoleAndEntity_returns_empty_for_any_users_and_any_permission_on_private_project_without_any_permission_in_DB() {
        ...
        PermissionsTestHelper.ALL_PERMISSIONS
                .forEach(perm -> {
                    assertThat(underTest.keepAuthorizedUsersForRoleAndEntity(dbSession, randomExistingUserUuids, perm,
                            project.getUuid()))
                            .isEmpty();
                });
        assertThat(underTest.keepAuthorizedUsersForRoleAndEntity(dbSession, randomExistingUserUuids, randomPermission,
    ...
    void countUsersWithGlobalPermissionExcludingGroupMember() {
        // u1 has the direct permission, u2 and u3 have the permission through their
        // group
        ...
        int count = underTest.countUsersWithGlobalPermissionExcludingGroupMember(dbSession, A_PERMISSION,
                group1.getUuid(),
                u2.getUuid());
        assertThat(count).isEqualTo(2);

        // excluding unknown memberships
        count = underTest.countUsersWithGlobalPermissionExcludingGroupMember(dbSession, A_PERMISSION, group1.getUuid(),
                MISSING_UUID);
        assertThat(count).isEqualTo(3);
        count = underTest.countUsersWithGlobalPermissionExcludingGroupMember(dbSession, A_PERMISSION, MISSING_UUID,
                u2.getUuid());
        assertThat(count).isEqualTo(3);

        // another permission
        count = underTest.countUsersWithGlobalPermissionExcludingGroupMember(dbSession, DOES_NOT_EXIST,
                group1.getUuid(),
                u2.getUuid());
    ...
    void countUsersWithGlobalPermissionExcludingUserPermission() {
        ...
        int count = underTest.countUsersWithGlobalPermissionExcludingUserPermission(dbSession, A_PERMISSION,
                u2.getUuid());
        assertThat(count).isEqualTo(2);
        ...
        // another permission
        count = underTest.countUsersWithGlobalPermissionExcludingUserPermission(dbSession, DOES_NOT_EXIST,
                u2.getUuid());
        assertThat(count).isZero();
    }
    ...
    void selectEntityPermissions_returns_permissions_of_logged_in_user_on_specified__project_through_anonymous_permissions() {
        ...
        assertThat(underTest.selectEntityPermissions(dbSession, project.getUuid(), user.getUuid())).containsOnly("p1",
                "p2");
    }
    ...
    void selectEntityPermissions_returns_permissions_of_logged_in_user_on_specified_project() {
        ...
        assertThat(underTest.selectEntityPermissions(dbSession, project.getUuid(), user.getUuid()))
                .containsOnly(ProjectPermission.CODEVIEWER.getKey());
    }
    ...
    void selectEntityPermissions_returns_permissions_of_logged_in_user_on_specified_private_project_through_all_possible_configurations() {
        ...
        assertThat(underTest.selectEntityPermissions(dbSession, project.getUuid(), user.getUuid())).containsOnly(
    ...
    void selectEntityPermissionsObtainedViaManagedGroup_shouldOnlyReturnGroupLevelPermissions() {
        ...
        Set<UserAndPermissionDto> permissionsViaGroup = underTest.selectEntityPermissionsObtainedViaManagedGroup(
                dbSession,
                project.getUuid(), "github");
    ...
    void selectEntityPermissionsObtainedViaManagedGroup_shouldOnlyReturnPermissionsFromRightManagedInstanceProvider() {
        ...
        db.users().insertEntityPermissionOnGroup(groupDtoManagedByGithero, "groupLevelPermissionThatShouldBeIgnored",
                project);
    ...
    void selectEntityPermissionsObtainedViaManagedGroup_shouldOnlyReturnPermissionsFromExpectedProject() {
        ...
        db.users().insertEntityPermissionOnGroup(groupDto, "groupLevelPermissionThatShouldBeIgnored",
                projectNotInScope);
    ...
    private GroupDto insertExternalGroup(String managedInstanceProvider) {
        ...
        db.users().insertExternalGroup(
                new ExternalGroupDto(groupDto.getUuid(), "ext_" + groupDto.getUuid(), managedInstanceProvider));
    ...
    void keepAuthorizedEntityUuids_filters_projects_authorized_to_logged_in_user_by_direct_permission() {
        ...
        assertThat(
                underTest.keepAuthorizedEntityUuids(dbSession, newHashSet(privateProject.getUuid(), Project.getUuid()),
                        user.getUuid(),
                        ProjectPermission.ADMIN))
    ...
    void keepAuthorizedEntityUuids_returns_empty_list_if_input_is_empty() {
        ...
        assertThat(underTest.keepAuthorizedEntityUuids(dbSession, newHashSet("does_not_exist"), user.getUuid(),
                ProjectPermission.USER))
                .isEmpty();
    }
    ...
    void keepAuthorizedEntityUuids_returns__projects_if_permission_USER_or_CODEVIEWER() {
        ...
        // logged-in user
        assertThat(underTest.keepAuthorizedEntityUuids(dbSession, newHashSet(Project.getUuid()), user.getUuid(),
                ProjectPermission.CODEVIEWER))
                .containsOnly(Project.getUuid());
        assertThat(underTest.keepAuthorizedEntityUuids(dbSession, newHashSet(Project.getUuid()), user.getUuid(),
                ProjectPermission.USER))
        ...
        // anonymous
        assertThat(underTest.keepAuthorizedEntityUuids(dbSession, newHashSet(Project.getUuid()), null,
                ProjectPermission.CODEVIEWER))
                .containsOnly(Project.getUuid());
        assertThat(
                underTest.keepAuthorizedEntityUuids(dbSession, newHashSet(Project.getUuid()), null,
                        ProjectPermission.USER))
                .containsOnly(Project.getUuid());
        assertThat(
                underTest.keepAuthorizedEntityUuids(dbSession, newHashSet(Project.getUuid()), null,
    ...
    void keepAuthorizedLoginsOnEntity_return_correct_users_on__project() {
        ...
        assertThat(underTest.keepAuthorizedLoginsOnEntity(dbSession, newHashSet(user1.getLogin()), project.getKey(),
                ProjectPermission.USER))
                .containsOnly(user1.getLogin());
        assertThat(underTest.keepAuthorizedLoginsOnEntity(dbSession,
                newHashSet(user1.getLogin(), admin1.getLogin(), admin2.getLogin()),
    ...
    void keepAuthorizedLoginsOnEntity_return_correct_users_on_private_project() {
        ...
        assertThat(underTest.keepAuthorizedLoginsOnEntity(dbSession, newHashSet(userWithNoRole.getLogin()),
                project.getKey(), ProjectPermission.USER))
                .isEmpty();
        assertThat(underTest.keepAuthorizedLoginsOnEntity(dbSession, newHashSet(user1.getLogin()), project.getKey(),
                ProjectPermission.USER))
        ...
        Set<String> allLogins = newHashSet(admin1.getLogin(), admin2.getLogin(), user1.getLogin(), user2.getLogin(),
                userWithNoRole.getLogin());

        // Admin does not have the USER permission set
        assertThat(
                underTest.keepAuthorizedLoginsOnEntity(dbSession, allLogins, project.getKey(), ProjectPermission.USER))
                .containsOnly(user1.getLogin(), user2.getLogin());
        assertThat(
                underTest.keepAuthorizedLoginsOnEntity(dbSession, allLogins, project.getKey(), ProjectPermission.ADMIN))
                .containsOnly(admin1.getLogin(), admin2.getLogin());
    }
