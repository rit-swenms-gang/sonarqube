...
public class ComponentTesting {
  ...
  public static ComponentDto newFileDto(ComponentDto branch, @Nullable ComponentDto directory) {
    return newFileDto(branch, directory, Uuids.create());
  }
  ...
  public static ComponentDto newFileDto(String mainBranchUuid, ComponentDto projectOrBranch,
      @Nullable ComponentDto directory) {
    return newFileDto(projectOrBranch, directory, Uuids.create(), mainBranchUuid);
  }
  ...
  public static ComponentDto newFileDto(ComponentDto branch, @Nullable ComponentDto directory, String fileUuid,
      @Nullable String mainBranchUuid) {
  ...
  public static ComponentDto newDirectory(ComponentDto branch, String path) {
    return newDirectory(branch, Uuids.create(), path);
  }

  public static ComponentDto newDirectoryOnBranch(ComponentDto branch, String path, String mainBranchUuid) {
    return newDirectory(branch, Uuids.create(), path, mainBranchUuid);
  }
  ...
  public static ComponentDto newPortfolio() {
    return newPortfolio(Uuids.create());
  }
  ...
  public static ComponentDto newApplication() {
    return newPortfolio(Uuids.create()).setQualifier(ComponentQualifiers.APP);
  }

  public static ComponentDto newProjectCopy(ProjectData project, ProjectData view) {
    return newProjectCopy(Uuids.create(), project.getMainBranchComponent(), view.getMainBranchComponent());
  }

  public static ComponentDto newProjectCopy(ProjectData project, PortfolioData view) {
    return newProjectCopy(Uuids.create(), project.getMainBranchComponent(), view.getRootComponent());
  }

  public static ComponentDto newProjectCopy(ComponentDto project, ComponentDto view) {
    return newProjectCopy(Uuids.create(), project, view);
  }
  ...
  public static ComponentDto newBranchComponent(ComponentDto project, BranchDto branchDto) {
    checkArgument(
        project.qualifier().equals(ComponentQualifiers.PROJECT) || project.qualifier().equals(ComponentQualifiers.APP));
    String uuid = branchDto.getUuid();
    return new ComponentDto()
        .setUuid(uuid)
        .setUuidPath(UUID_PATH_OF_ROOT)
