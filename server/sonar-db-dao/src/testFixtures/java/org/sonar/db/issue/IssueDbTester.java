...
public class IssueDbTester {
   ...
   */
  @SafeVarargs
  public final IssueDto insert(RuleDto rule, ComponentDto project, ComponentDto file,
      Consumer<IssueDto>... populators) {
   ...
   */
  @SafeVarargs
  public final IssueDto insertIssue(RuleDto rule, ComponentDto branch, ComponentDto file,
      Consumer<IssueDto>... populators) {
   ...
   */
  @SafeVarargs
  public final IssueDto insertHotspot(RuleDto rule, ComponentDto project, ComponentDto file,
      Consumer<IssueDto>... populators) {
  ...
  public final IssueDto insertHotspot(RuleDto rule, ProjectData project, ComponentDto file,
      Consumer<IssueDto>... populators) {
  ...
  public IssueChangeDto insertComment(IssueDto issueDto, @Nullable UserDto user, String text) {
    IssueChangeDto issueChangeDto = IssueChangeDto.of(
        DefaultIssueComment.create(issueDto.getKey(), user == null ? null : user.getUuid(), text),
  ...
  public void insertFieldDiffs(IssueDto issueDto, FieldDiffs... diffs) {
    Arrays.stream(diffs)
        .forEach(diff -> db.getDbClient().issueChangeDao().insert(db.getSession(),
            IssueChangeDto.of(issueDto.getKey(), diff, issueDto.getProjectUuid())
  ...
  public void insertNewCodeReferenceIssue(IssueDto issue) {
    db.getDbClient().issueDao().insertAsNewCodeOnReferenceBranch(db.getSession(),
        IssueTesting.newCodeReferenceIssue(issue));
    db.commit();
  }
}
